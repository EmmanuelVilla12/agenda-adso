...
function App() {
  ...
  // ✅ SOLO ESTO SE AGREGA (no rompe tu lógica)
  ...
  return (
    <>
      {/* ✅ MODAL DE LOGIN (nuevo, no altera tu flujo) */}
      {!isAuthenticated && <LoginModal />}

      {/* ✅ BLOQUEA INTERACCIÓN SI NO HAY LOGIN */}
              ...
              <div className="text-right">
                ...
                {isAuthenticated && (
                  <div className="mt-2 flex items-center gap-2 justify-end">
                    ...
                    <button
                      onClick={logout}
                      className="text-xs bg-red-500 px-2 py-1 rounded-md text-white hover:bg-red-600"
                    >
                      Cerrar sesión
                    </button>
                  </div>
